        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceMultiplier = table.Column<decimal>(type: "numeric(3,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAproved = table.Column<bool>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    IsStarAlliance = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(nullable: false),
                    IsAproved = table.Column<bool>(nullable: false),
                    BoughtMiles = table.Column<int>(nullable: false),
                    ProlongedMiles = table.Column<int>(nullable: false),
                    TransferedMiles = table.Column<int>(nullable: false),
                    BirtDate = table.Column<int>(nullable: false),
                    RevisionMonth = table.Column<int>(nullable: false),
                    UserId = table.Column<string>(nullable: true),
                    GifterId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Clients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Clients_Clients_GifterId",
                        column: x => x.GifterId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseMilesPrice = table.Column<decimal>(nullable: false),
                    StartAirportId = table.Column<int>(nullable: false),
                    EndAirportId = table.Column<int>(nullable: false),
                    FlightStart = table.Column<DateTime>(nullable: false),
                    FlightEnd = table.Column<DateTime>(nullable: false),
                    FlightCompanyId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Flights_Partners_FlightCompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpirationDate = table.Column<DateTime>(nullable: false),
                    MilesTypeId = table.Column<int>(nullable: false),
